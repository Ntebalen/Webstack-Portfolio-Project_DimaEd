...
const initState = {
  name: "Python",
  description:
    "Explore DimaEd's diverse selection of Python courses to master coding in this exceptionally versatile language. With its straightforward syntax and readability, Python is ideal for projects like Flask, Django, data science, and machine learning. Discover the art of crafting anything from games to websites to applications. Select from a variety of courses that will guide you through the process..",
};
