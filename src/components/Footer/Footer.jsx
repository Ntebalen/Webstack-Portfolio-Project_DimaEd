    ...
    <FooterContainer>
      <FooterSection>
        <FooterTop>
          ...
          <FooterListUl>
            <FooterListLi><FooterLink href="#">DimaEd Business</FooterLink></FooterListLi>
            <FooterListLi><FooterLink href="#">Teach on DimaEd</FooterLink></FooterListLi>
        ...
        <FooterBottom>
          <div><LogoLink href="#"><LogoImg src="/images/footer/DimaEd_logo.png"/></LogoLink></div>
          <Copyright>&copy; 2023 DimaEd, Inc.</Copyright>
        </FooterBottom>
      </FooterSection>
    </FooterContainer>
  )
