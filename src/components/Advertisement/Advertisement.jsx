...
const Advertisement = () => {
  return (
        ...
        <AdvertisementContain>
          <AdvertisementWrapper>
            ...
            <Description>
              ...
              <DescriptionPara>Global educators on DimaEd are guiding millions of students. Equip yourself with the tools and skills to teach what you're passionate about</DescriptionPara>
              <div>
                <LinkButton height='4.8rem'>Embark on your teaching journey today!</LinkButton>
              </div>
            </Description>
          </AdvertisementWrapper>
        </AdvertisementContain>
    ...
    <CompanyLogo>
      <CompanyLogoSection>
        <CompanyLogoContain>
          <CompanyLogoHeading>Backed and trusted by companies, regardless of their size.</CompanyLogoHeading>
          <CompanyLogoWrapper>
            <CompanyLogoEach>
      ...
      <AdvertisementSection>
        <AdvertisementContain>
          <AdvertisementWrapper2>
            <Description2>
              <DescriptionHeadingImg src="/images/advertisement/DimaEd_Business.png" style={{ width:200 , height: 100}} />
              <DescriptionPara>Get unlimited access to 6,000+ of DimaEd’s top courses for your team. Learn and improve skills across business, tech, design, and more.</DescriptionPara>
              <div>
                <LinkButton height='4.8rem'>Get DimaEd business</LinkButton>
              </div>
            </Description2>
        ...
        <AdvertisementContain>
          ...
          <AdvertisementImg src="/images/advertisement/transform-2x-v3.jpeg" />
            ...
            <DescriptionHeading>Transform your life through education</DescriptionHeading>
              <DescriptionPara>Globally, learners are launching fresh careers, making strides in their fields, and enriching their lives.</DescriptionPara>
              <div>
                <LinkButton height='4.8rem'>Discover the how – dive in and find out!</LinkButton>
              </div>
            </Description>
          </AdvertisementWrapper>
        </AdvertisementContain>
